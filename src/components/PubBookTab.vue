...
<template>
  <div class="pubBook">
    <div class="conBigTitle">
      <h2>{{ tabTitle }}</h2>
      <p>
        <a href="" target="_blank" rel="noopener">史记</a> |
        <a href="" target="_blank" rel="noopener">汉书</a> |
        <a href="" target="_blank" rel="noopener">后汉书</a> |
        <a href="" target="_blank" rel="noopener">三国志</a> |
    ...
    <div class="show">
          ...
          <li>
            <a href="" target="_blank">
              <img
                ...
                :title="item.desc" :alt="item.title" class="lazy">
            </a>
            <p class="bookName">
              <a href="" :title="item.desc" target="_blank">{{ item.title }}</a>
            </p>
            <p>{{ item.author }}</p>
          </li>
        </ul>
      ...
      <div class="showRight">
        ...
        <ul v-for="(item, index) in bookList" :key="item.id">
          <li class="">
            <dl class="close">
              <dt>{{ index + 1 }}</dt>
              <dd>
            ...
            <dl class="open">
              ...
              <dd>
                <div>
                  <span class="bookPic">
                    <a href="" target="_blank" :title=item.desc>
                      <img
